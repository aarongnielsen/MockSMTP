...
public class ViewRawMessageHandlerTest {
    ...
    public void handle_testByPathAndIndex(String urlPath, int mailIndex, boolean expectedHandled) throws ServletException, IOException {
        ...
        if (!expectedHandled) {
            ...
            Assertions.assertTrue(responseStringWriter.toString().contains("This is the body of Email " + mailIndex));
    ...
    private static MockMail createMockMail(int index) {
        ...
        mockMail.setRawMail(
                "From: " + mockMail.getFrom() + "\r\n" +
                "To: " + mockMail.getTo() + "\r\n" +
                "Subject: " + mockMail.getSubject() + "\r\n" +
                "\r\n" +
                "This is the body of Email " +  index + ".\r\n"
        );
        return mockMail;
    }
}
